...
int main(int argc,char **argv)
{
	...
	ros::Subscriber pos_sub3 = nh.subscribe("/vrpn_client_node/tello_4/pose", 10, cb_readPos_3);
	ros::Subscriber pos_sub4 = nh.subscribe("/vrpn_client_node/tello_6/pose", 10, cb_readPos_4);
	...
	{	
		...
		if(command == 2)  //进行编队
			{	
					h1[0][0] = r * sin(w * t + PI / 4);
					h1[1][0] = r * cos(w * t + PI / 4);
					h2[0][0] = r * sin(w * t + PI * 3 / 4);
					h2[1][0] = r * cos(w * t + PI * 3 / 4);
					h3[0][0] = r * sin(w * t + PI * 5 / 4);
					h3[1][0] = r * cos(w * t + PI * 5 / 4);
					h4[0][0] = r * sin(w * t + PI * 7 / 4);
					h4[1][0] = r * cos(w * t + PI * 7 / 4);
					//h5[0][0] = r * sin(w * t + PI * 4 / 3);
					//h5[1][0] = r * cos(w * t + PI * 4 / 3);
					//h6[0][0] = r * sin(w * t + PI * 5 / 3);
					//h6[1][0] = r * cos(w * t + PI * 5 / 3);

					v1[0][0] = r * w * cos(w * t + PI / 4);
					v1[1][0] = -r * w * sin(w * t + PI / 4);
					v2[0][0] = r * w * cos(w * t + PI * 3 / 4);
					v2[1][0] = -r * w * sin(w * t + PI * 3 / 4);
					v3[0][0] = r * w * cos(w * t + PI * 5 / 4);
					v3[1][0] = -r * w * sin(w * t + PI * 5 / 4);
					v4[0][0] = r * w * cos(w * t + PI * 7 / 4);
					v4[1][0] = -r * w * sin(w * t + PI * 7 / 4);
				...
				{	
					h1[0][0] = r * sin(w * (t-50));
					h1[1][0] = r * cos(w * (t-50));
					h2[0][0] = r * sin(w * (t-50) + PI * 2 / 3);
					h2[1][0] = r * cos(w * (t-50) + PI * 2 / 3);
					h3[0][0] = r * sin(w * (t-50) + PI * 4 / 3);
					h3[1][0] = r * cos(w * (t-50) + PI * 4 / 3);
					h4[0][0] = 0;
					h4[1][0] = 0;
					//h5[0][0] = r * sin(-w * (t-50) + PI * 4 / 3);
					//h5[1][0] = r * cos(-w * (t-50) + PI * 4 / 3);
					//h6[0][0] = r * sin(-w * (t-50) + PI * 5 / 3);
					//h6[1][0] = r * cos(-w * (t-50) + PI * 5 / 3);

					v1[0][0] = r * w * cos(w * (t-50));
					v1[1][0] = -r * w * sin(w * (t-50));
					v2[0][0] = r * w * cos(w * (t-50) + PI * 2 / 3);
					v2[1][0] = -r * w * sin(w * (t-50) + PI * 2 / 3);
					v3[0][0] = r * w * cos(w * (t-50) + PI * 4 / 3);
					v3[1][0] = -r * w * sin(w * (t-50) + PI * 4 / 3);
					v4[0][0] = 0;
					v4[1][0] = 0;
					//v5[0][0] = -r * w * cos(w * t + PI * 4 / 3);
					//v5[1][0] = r * w * sin(w * t + PI * 4 / 3);
				...
				if (t > 130)
				{
					...
					h1[0][0] = r * sin(w * (t-130) + PI * 3 / 2)+1;
					h1[1][0] = r * cos(w * (t-130) + PI * 3 / 2);
					h2[0][0] = r * sin(w * (t-130) + PI * 2 / 4)+1;
					h2[1][0] = r * cos(w * (t-130) + PI * 2 / 4);
					h3[0][0] = r * sin(w * (t-130) )-1;
					h3[1][0] = r * cos(w * (t-130) );
					h4[0][0] = r * sin(w * (t-130) + PI)-1;
					h4[1][0] = r * cos(w * (t-130) + PI);
					//h5[0][0] = r * sin(-w * t + PI * 4 / 3);
					//h5[1][0] = r * cos(-w * t + PI * 4 / 3);
					//h6[0][0] = r * sin(-w * t + PI * 5 / 3);
					//h6[1][0] = r * cos(-w * t + PI * 5 / 3);

					v1[0][0] = r * w * cos(w * (t-130) + PI * 3 / 2);
					v1[1][0] = -r * w * sin(w * (t-130) + PI * 3 / 2);
					v2[0][0] = r * w * cos(w * (t-130) + PI * 2 / 4);
					v2[1][0] = -r * w * sin(w * (t-130) + PI * 2 / 4);
					v3[0][0] = r * w * cos(w * (t-130));
					v3[1][0] = -r * w * sin(w * (t-130));
					v4[0][0] = r * w * cos(w * (t-130) + PI);
					v4[1][0] = -r * w * sin(w * (t-130) + PI);
					//v5[0][0] = -r * w * cos(w * t + PI * 4 / 3);
					//v5[1][0] = r * w * sin(w * t + PI * 4 / 3);
					//v6[0][0] = -r * w * cos(w * t + PI * 5 / 3);
					//v6[1][0] = r * w * sin(w * t + PI * 5 / 3);
			...
			//u5[0][0] = B * K * (tello_pos5[0][0] - h5[0][0]) + B * v5[0][0] + B * F5[0][0]+u7[0][0];
			//u6[0][0] = B * K * (tello_pos6[0][0] - h6[0][0]) + B * v6[0][0] + B * F6[0][0]+u7[0][0];
			...
			//u5[1][0] = B * K * (tello_pos5[1][0] - h5[1][0]) + B * v5[1][0] + B * F5[1][0]+u7[1][0];
			//u6[1][0] = B * K * (tello_pos6[1][0] - h6[1][0]) + B * v6[1][0] + B * F6[1][0]+u7[1][0];
			...
			u6[2][0] = B * K * (tello_pos6[2][0] - 1) ;
				...
				cmd_vel1.linear.x=0.2*u1[0][0];
				cmd_vel1.linear.y=0.2*u1[1][0];
				cmd_vel1.linear.z=0.5*u1[2][0];
				cmd_vel2.linear.x=0.2*u2[0][0];
				cmd_vel2.linear.y=0.2*u2[1][0];
				cmd_vel2.linear.z=0.5*u2[2][0];
				cmd_vel3.linear.x=0.2*u3[0][0];
				cmd_vel3.linear.y=0.2*u3[1][0];
				cmd_vel3.linear.z=0.5*u3[2][0];
				cmd_vel4.linear.x=0.2*u4[0][0];
				cmd_vel4.linear.y=0.2*u4[1][0];
				cmd_vel4.linear.z=0.5*u4[2][0];
				//cmd_vel5.linear.x=0.1*u5[0][0];
				//cmd_vel5.linear.y=0.1*u5[1][0];
				//cmd_vel6.linear.x=0.1*u6[0][0];
				//cmd_vel6.linear.y=0.1*u6[1][0];
		...
		if (command == 3)  // 指令速度给0,但期望航向角不变
			{
				cmd_vel1.linear.x=0.1*u1[0][0];
				cmd_vel1.linear.y=0.1*u1[1][0];
				cmd_vel2.linear.x=0.1*u2[0][0];
				cmd_vel2.linear.y=0.1*u2[1][0];
				cmd_vel3.linear.x=0.1*u3[0][0];
				cmd_vel3.linear.y=0.1*u3[1][0];
				cmd_vel4.linear.x=0.1*u4[0][0];
				cmd_vel4.linear.y=0.1*u4[1][0];
