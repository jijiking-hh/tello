...
double t=0,tstart=0;
int i,j,flag=0;
double A=0,B=1,B_hat=0,B_tlide=1,K=-3.3181,u1[2][1],u2[2][1],u3[2][1],u4[2][1],u5[2][1], u6[2][1], u7[2][1];
...
int main(int argc,char **argv)
{
	...
	{	
		...
		if(command == 2)  //进行编队
			...
			u1[0][0] = B * K * (tello_pos1[0][0] - h1[0][0]) + B * v1[0][0] + B * F1[0][0]+u7[0][0];//
			u2[0][0] = B * K * (tello_pos2[0][0] - h2[0][0]) + B * v2[0][0] + B * F2[0][0]+u7[0][0];//+ B * K * (tello_pos2[0][0] - h2[0][0] - tello_pos5[0][0])  
			u3[0][0] = B * K * (tello_pos3[0][0] - h3[0][0]) + B * v3[0][0] + B * F3[0][0]+u7[0][0];//+ B * K * (tello_pos3[0][0] - h3[0][0] - tello_pos5[0][0])  
			u4[0][0] = B * K * (tello_pos4[0][0] - h4[0][0]) + B * v4[0][0] + B * F4[0][0]+u7[0][0];//+ B * K * (tello_pos4[0][0] - h4[0][0] - tello_pos5[0][0])  
			u5[0][0] = B * K * (tello_pos5[0][0] - h5[0][0]) + B * v5[0][0] + B * F5[0][0]+u7[0][0];
			u6[0][0] = B * K * (tello_pos6[0][0] - h6[0][0]) + B * v6[0][0] + B * F6[0][0]+u7[0][0];
			
			u1[1][0] = B * K * (tello_pos1[1][0] - h1[1][0]) + B * v1[1][0] + B * F1[1][0]+u7[1][0];//
			u2[1][0] = B * K * (tello_pos2[1][0] - h2[1][0]) + B * v2[1][0] + B * F2[1][0]+u7[1][0];//+ B * K * (tello_pos2[1][0] - h2[1][0] - tello_pos5[1][0])  
			u3[1][0] = B * K * (tello_pos3[1][0] - h3[1][0]) + B * v3[1][0] + B * F3[1][0]+u7[1][0];//+ B * K * (tello_pos3[1][0] - h3[1][0] - tello_pos5[1][0])   
			u4[1][0] = B * K * (tello_pos4[1][0] - h4[1][0]) + B * v4[1][0] + B * F4[1][0]+u7[1][0];//+ B * K * (tello_pos4[1][0] - h4[1][0] - tello_pos5[1][0])  
