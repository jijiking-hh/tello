1.运行gazebo
roslaunch hector_quadrotor_demo gazebo_tello_bishe_1.launch 
...
rosservice call /tello7/enable_motors "enable: true" 
rosservice call /tello8/enable_motors "enable: true"
